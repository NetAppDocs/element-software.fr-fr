...
* link:../storage/task_system_manage_cluster_ntp_configure.html["Configuration des serveurs Network Time Protocol pour que le cluster puisse effectuer une requête"]
