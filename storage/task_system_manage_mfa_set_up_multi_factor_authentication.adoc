...
Vous trouverez des informations détaillées sur chaque méthode de l'API dans le link:../api/concept_element_api_about_the_api.html["Référence de l'API d'élément"].
