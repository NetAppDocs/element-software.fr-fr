...
*  cluster administrator accounts,L'administrateur compte pour le cluster de stockage
*  accounts,Les comptes utilisateurs de l'accès au volume de stockage
*  cluster user accounts,Comptes utilisateurs de cluster faisant autorité pour NetApp Hybrid Cloud Control
