...
Pour configurer l'authentification multifacteur (MFA), consultez link:../storage/task_system_manage_mfa_set_up_multi_factor_authentication.html["le système active l'authentification multifacteur"] documentation.
