...
.Étapes
. Téléchargez la certification OVA ou ISO pour votre installation depuis la link:https://mysupport.netapp.com/site/products/all/details/element-software/downloads-tab["Logiciel Element"^] page du site de support NetApp. La nouvelle OVA contient un certificat SSL mis à jour.
+
