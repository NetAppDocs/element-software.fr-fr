...
summary: 'La méthode GetLldpInfo renvoie une réponse similaire à l"exemple suivant.' 
---
= GetLldpInfo
:allow-uri-read: 
:icons: font
...
[role="lead"]
Le `GetLldpInfo` la méthode renvoie une réponse similaire à l'exemple suivant.
