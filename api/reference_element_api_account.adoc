...
[role="lead"]
Le `account` l'objet contient des informations sur un compte. Cet objet inclut uniquement les informations « configurées » sur le compte, pas les informations d'exécution ou d'utilisation.
