...
summary: 'La méthode GetNvramInfo renvoie une réponse similaire à l"exemple suivant.' 
---
= GetNvramInfo
:allow-uri-read: 
:icons: font
...
[role="lead"]
Le `GetNvramInfo` la méthode renvoie une réponse similaire à l'exemple suivant.
