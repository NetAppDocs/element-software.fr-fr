...
summary: Vous pouvez utiliser la méthode SetNodeSSLCertificate pour définir un certificat SSL utilisateur et une clé privée pour le noeud de gestion. 
---
...
[role="lead"]
Vous pouvez utiliser le `SetNodeSSLCertificate` Méthode permettant de définir un certificat SSL utilisateur et une clé privée pour le nœud de gestion.
