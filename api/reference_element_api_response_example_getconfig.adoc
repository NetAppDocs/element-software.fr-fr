...
summary: 'La méthode getconfig renvoie une réponse similaire à l"exemple suivant. Du fait de sa longueur, la réponse contient des informations relatives à un seul nœud du cluster.' 
---
= Getconfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
Le `GetConfig` la méthode renvoie une réponse similaire à l'exemple suivant. Du fait de sa longueur, la réponse contient des informations relatives à un seul nœud du cluster.
