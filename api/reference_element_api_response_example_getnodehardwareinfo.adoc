...
summary: 'La méthode GetNodeHardwareInfo pour iSCSI renvoie une réponse similaire à l"exemple suivant.' 
---
...
[role="lead"]
Le `GetNodeHardwareInfo` La méthode pour iSCSI renvoie une réponse similaire à l'exemple suivant.
