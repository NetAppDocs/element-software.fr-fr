...
summary: Vous pouvez utiliser la méthode GetNodeSSLCertificate pour récupérer le certificat SSL actuellement actif sur le nœud de gestion. 
---
...
[role="lead"]
Vous pouvez utiliser le `GetNodeSSLCertificate` Méthode pour récupérer le certificat SSL actuellement actif sur le nœud de gestion.
