...
[NOTE]
====
* Cette méthode n'active pas le chiffrement logiciel au repos. Ceci peut uniquement être effectué à l'aide du link:../api/reference_element_api_createcluster.html["créer une méthode de cluster"^] avec `enableSoftwareEncryptionAtRest` réglez sur `true`.
