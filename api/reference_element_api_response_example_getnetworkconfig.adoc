...
summary: 'La méthode GetNetworkConfig renvoie une réponse similaire à l"exemple suivant.' 
---
= GetNetworkConfig
:allow-uri-read: 
:icons: font
...
[role="lead"]
Le `GetNetworkConfig` la méthode renvoie une réponse similaire à l'exemple suivant.
