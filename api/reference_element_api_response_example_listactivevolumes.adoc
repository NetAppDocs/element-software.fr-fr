...
summary: 'La méthode ListenceActivevolumes renvoie une réponse similaire à l"exemple suivant.' 
---
= ActivéNon
:allow-uri-read: 
:icons: font
...
[role="lead"]
Le `ListActiveVolumes` la méthode renvoie une réponse similaire à l'exemple suivant.
