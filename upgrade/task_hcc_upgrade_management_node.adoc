...
Vous pouvez effectuer une mise à niveau sans déplacement du nœud de gestion de la version 12.3.x ou ultérieure vers la version 12.5 ou ultérieure sans avoir à provisionner une nouvelle machine virtuelle de nœud de gestion.
...
.Étapes
. Connectez-vous à la machine virtuelle du nœud de gestion via une connexion SSH ou un accès à la console.
. Téléchargez le https://mysupport.netapp.com/site/products/all/details/element-software/downloads-tab["ISO du nœud de gestion"^] logiciel pour Element depuis le site du support NetApp vers la VM du nœud de gestion.
+
