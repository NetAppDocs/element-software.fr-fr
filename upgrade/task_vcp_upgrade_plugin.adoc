...
Le pack de services de gestion 2.22.7 inclut le plug-in Element pour vCenter Server 5.0, qui contient le plug-in distant. Si vous utilisez le plug-in Element, vous devez effectuer une mise à niveau vers les services de gestion 2.22.7 ou une version ultérieure afin de respecter la directive VMware qui supprime la prise en charge des plug-ins locaux. https://kb.vmware.com/s/article/87880["En savoir plus >>"^] .
